...
''')
            ...
            class MockValidator:
                def validate_symbol_docstring(self, symbol_path):
                    class MockResult:
                        errors = []
                        warnings = []
            ...
            results = validate_changed_files([test_file], config, MockValidator())
    ...
    def test_file_filtering(self):
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            results = validate_changed_files([py_file, txt_file], config, MockValidator())
...
class TestValidateSymbols:
    def test_validation_with_errors(self):
        ...
        results = validate_symbols({symbol_info}, MockValidator())
